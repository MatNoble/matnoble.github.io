...
let title=document.createElement("h1");title.id="search-results";title.className="list-title";if(results.length==0){title.textContent="No results found for “{}”".replace("{}",term);}else if(results.length==1){title.textContent="Found one result for “{}”".replace("{}",term);}else{title.textContent="Found 13579 results for “{}”".replace("{}",term).replace("13579",results.length);}
